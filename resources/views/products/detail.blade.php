                        ...
                        <div id="similar-product" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active thumbnails">
                                    <a href="{{asset('images/backend_img/products/large/'.$productDetails->image)}}" data-standard="{{asset('images/backend_img/products/small/'.$productDetails->image)}}">
                                    ...
                                    <a href="{{asset('images/backend_img/products/large/'.$altImages->image)}}" data-standard="{{asset('images/backend_img/products/small/'.$altImages->image)}}">
